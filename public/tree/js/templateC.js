...
//OrgChart.templates.neet.svg = '<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="display:block;background-color: #1E1E1E;" width="{w}" height="{h}" viewBox="{viewBox}">{content}</svg>';
...
OrgChart.templates.yellow.field_0 = '<clipPath id="{randId}"><circle cx="50" cy="50" r="46"></circle></clipPath><text width="210" class="field_0" style="font-size: 18px;" font-weight="bold" fill="#322b28" x="50" y="50" text-anchor="middle">{val}</text>',
...
OrgChart.templates.orangeEdge.field_0 = '<clipPath id="{randId}"><circle cx="50" cy="50" r="46"></circle></clipPath><text width="210" class="field_0" style="font-size: 18px;" font-weight="bold" fill="#322b28" x="50" y="50" text-anchor="middle">{val}</text>',
...
OrgChart.templates.blueEdge.field_0 = '<clipPath id="{randId}"><circle cx="50" cy="50" r="46"></circle></clipPath><text width="210" class="field_0" style="font-size: 18px;" font-weight="bold" fill="#322b28" x="50" y="50" text-anchor="middle">{val}</text>',
...
OrgChart.templates.orange.min.node = '<rect x="-3" y="20" fill="#1E1E1E" width="17" height="50"></rect>' +
...
OrgChart.templates.blue.min.node = '<rect x="-3" y="20" fill="#1E1E1E" width="17" height="45"></rect>' +
...
// var nodes = [
//     { id: 1, tags: ["yellow"], img: 'https://cdn.balkan.app/shared/1.jpg' ,Name:'fawzy'},
